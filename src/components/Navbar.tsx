      ...
      <nav className="sticky top-0 bg-white/95 backdrop-blur-md z-40 border-b border-brand-bg py-4 px-6 shadow-sm">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-bold text-slate-600">
            ...
            <Link to="/quote" className="hover:text-brand-green transition">Instant Quote</Link>
            <Link to="/reviews" className="hover:text-brand-green transition">Reviews</Link>
            <Link to="/blog" className="hover:text-brand-green transition">Advice Blog</Link>
          </div>
