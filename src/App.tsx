...
function AppContent() {
  ...
  // Handle dynamic routing for individual blog posts
  const blogPostMatch = path.match(/^\/blog\/([^/]+)$/);
  const matchedPost = blogPostMatch ? BLOG_POSTS.find(p => p.slug === blogPostMatch[1]) : null;

  // Render Navbar and Footer around every page, displaying dynamic content in the middle
  return (
    <div className="min-h-screen bg-brand-bg font-sans text-brand-navy scroll-smooth">
      ...
      <main>
        {matchedPost ? (
          /* Render Full Dedicated Blog Post Page */
          <article className="py-16 px-6 bg-white max-w-4xl mx-auto">
            <div className="mb-8">
              <Link to="/blog" className="inline-flex items-center gap-2 text-brand-green font-bold text-sm hover:underline mb-6">
                <ArrowLeft size={16} /> Back to Advice Portal
              </Link>
              
              <div className="flex items-center gap-4 text-xs font-bold text-slate-500 mb-4">
                <span className="flex items-center gap-1"><Calendar size={12} /> {matchedPost.date}</span>
                <span>•</span>
                <span className="flex items-center gap-1"><Clock size={12} /> {matchedPost.readTime}</span>
              </div>

              <h1 className="text-4xl md:text-5xl font-black text-brand-navy tracking-tight leading-tight uppercase">
                {matchedPost.title}
              </h1>
              
              <p className="text-xs text-slate-500 mt-3 font-semibold">
                Written by: <span className="text-slate-800">{matchedPost.author}</span>
              </p>
            </div>

            {/* Post Header Image */}
            <div className="h-[400px] w-full rounded-3xl overflow-hidden bg-slate-100 mb-10 shadow-sm">
              <img 
            ...
            {/* Post Content */}
            <div className="prose prose-slate max-w-none text-slate-600 text-lg leading-relaxed space-y-6 whitespace-pre-wrap">
              {matchedPost.content}
            </div>

            {/* Banner CTA block inside post */}
            <div className="mt-16 bg-[#f0f4ee] border border-brand-green/20 rounded-3xl p-8 text-center space-y-4">
              <h3 className="text-2xl font-black text-brand-navy">Ready to refresh your home?</h3>
              <p className="text-slate-600 max-w-md mx-auto text-sm">
                Support Geneva's hardest working college students. Use our dynamic calculator to get an instant quote on your siding or concrete wash today!
              </p>
              <div className="pt-2">
                <Link to="/quote" className="inline-block bg-brand-green hover:bg-[#256a47] text-white font-black text-xs px-6 py-3.5 rounded-xl uppercase tracking-wider shadow-md">
          ...
          /* Render Dedicated Services Page */
          <div className="py-16 bg-white">
            <section className="px-6 max-w-6xl mx-auto">
              <div className="text-center space-y-3 max-w-2xl mx-auto mb-16">
                ...
                <h1 className="text-4xl font-black text-brand-navy font-display tracking-tighter uppercase">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-md transition duration-300 flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div className="pt-6 mt-6 border-t border-slate-50">
                    <Link to="/quote" className="block text-center py-3.5 px-4 bg-brand-navy/5 hover:bg-brand-navy/10 text-brand-navy font-black text-xs rounded-xl transition cursor-pointer uppercase tracking-wider">
                      Select Siding Wash
                    </Link>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-md transition duration-300 flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div className="pt-6 mt-6 border-t border-slate-50">
                    <Link to="/quote" className="block text-center py-3.5 px-4 bg-brand-green/5 hover:bg-brand-green/10 text-brand-green font-black text-xs rounded-xl transition cursor-pointer uppercase tracking-wider">
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-md transition duration-300 flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div className="pt-6 mt-6 border-t border-slate-50">
                    <Link to="/quote" className="block text-center py-3.5 px-4 bg-amber-50 hover:bg-amber-100 text-amber-700 font-black text-xs rounded-xl transition cursor-pointer uppercase tracking-wider">
          ...
          /* Render Dedicated Quote Page */
          <div className="py-16 bg-white px-6">
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center space-y-3">
                <span className="inline-flex items-center gap-2 bg-[#f0f9f4] border border-brand-green/20 text-brand-green font-black px-3.5 py-1.5 rounded-full text-xs uppercase tracking-widest">
                  <Sparkles size={14} /> Calculate Live Pricing
                </span>
                ...
                <p className="text-slate-600 max-w-lg mx-auto">
                  Adjust variables to calculate your flat-rate or square foot pricing estimate instantly. No hidden commissions or service fees.
                </p>
              </div>
              <div className="bg-brand-bg rounded-3xl p-6 md:p-10 border border-slate-100 shadow-sm">
                <QuoteCalculator />
              </div>
            </div>
          </div>
        ) : path === '/reviews' ? (
          /* Render Dedicated Reviews Page */
          <div className="py-16 bg-brand-bg">
            <div className="max-w-6xl mx-auto">
              <div className="text-center space-y-3 max-w-2xl mx-auto mb-12">
                <span className="inline-flex items-center gap-1.5 bg-brand-navy text-white text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full">
                  <Star size={12} className="fill-brand-yellow text-brand-yellow" /> Local 5-Star Reviews
                </span>
                <h1 className="text-4xl font-black text-brand-navy tracking-tight uppercase">
                  What Geneva Residents Say
                </h1>
                <p className="text-slate-600">
                  Read raw reviews from homeowners in Kane County. From Mill Creek to Eagle Brook, our high-volume soft washing has restored over 50 homes this month.
                </p>
              </div>
              <ReviewsSection />
            </div>
          ...
          /* Render Dedicated Advice Blog Portal Page */
          <div className="py-16 bg-white">
            <div className="max-w-6xl mx-auto">
              <div className="text-center space-y-3 max-w-2xl mx-auto mb-12">
                <span className="inline-flex items-center gap-1.5 bg-[#f0f9f4] text-brand-green text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full border border-brand-green/10">
                  <GraduationCap size={12} /> Expert Neighborhood Advice
                </span>
                <h1 className="text-4xl font-black text-brand-navy tracking-tight uppercase">
                  The College Dudes Advice Portal
                </h1>
                <p className="text-slate-600">
                  Comprehensive articles on vinyl siding mold growth, cleaning schedules, and eco-friendly property maintenance.
                </p>
              </div>
          ...
          /* Render Full Standard Landing Home Page */
          <>
            ...
            <section id="services" className="py-24 px-6 max-w-6xl mx-auto">
              ...
              <div className="mt-12 bg-brand-navy text-white rounded-3xl p-6 md:p-10 relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-8 border border-white/5 shadow-lg">
                ...
                <div className="flex flex-col items-center gap-3 shrink-0 w-full md:w-auto">
                  ...
                  <Link to="/quote" className="w-full md:w-auto bg-brand-yellow hover:bg-[#ebd34b] text-brand-navy font-black text-xs px-6 py-3.5 rounded-xl shadow-md hover:scale-[1.01] transition text-center cursor-pointer uppercase tracking-wider">
            ...
            {/* Meet the Owner & Co-Founder Section */}
            <section className="bg-brand-bg py-20 border-b border-[#dfebd9]/20 px-6">
              <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-0 items-stretch">
                  ...
                  <div className="md:col-span-5 relative min-h-[320px] bg-slate-100">
                    <img
                      src="/owner-jace-jessup.jpeg"
                      alt="Jace Jessup with his wife and family dog"
                    ...
                    <div className="absolute bottom-4 left-4 md:hidden text-white">
                      <p className="text-xs font-bold uppercase tracking-widest text-brand-yellow">Owner & Co-Founder</p>
                      <h3 className="text-xl font-black uppercase">Jace Jessup</h3>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-7 p-8 md:p-12 flex flex-col justify-center space-y-6">
                    <div className="space-y-2">
                      <span className="hidden md:inline-block bg-brand-navy text-white text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest">
                        Owner & Co-Founder
                      </span>
                      <h3 className="text-3xl font-black text-brand-navy tracking-tight leading-none uppercase">
                        Meet Jace Jessup
                      </h3>
                      <p className="text-xs font-semibold text-brand-green uppercase tracking-wider">
                        College Student & Geneva Local
                      </p>
                    </div>

                    <p className="text-slate-600 text-base leading-relaxed italic">
                      "I’m a local college student putting myself through school. I started **College Dudes Power Cleaning** with one clear goal: to provide elite, professional-grade exterior cleaning services while working hard to pay for my college education and support my wife and our newborn son."
                    </p>

                    <div className="border-t border-slate-100 pt-6 flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-brand-green/10 text-brand-green flex items-center justify-center font-black italic text-lg shadow-sm">
                        JJ
                      </div>
                      <div>
                        <h4 className="font-bold text-slate-800 text-sm">Jace Jessup</h4>
                        <p className="text-xs text-slate-400">Co-Founder, College Dudes Power Cleaning</p>
                      </div>
                    </div>
                  </div>
                </div>
